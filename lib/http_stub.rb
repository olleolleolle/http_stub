...
require File.expand_path('../http_stub/configurer/stub_http_request_factory', __FILE__)
require File.expand_path('../http_stub/configurer/stub_activator_http_request_factory', __FILE__)
require File.expand_path('../http_stub/configurer/request', __FILE__)
