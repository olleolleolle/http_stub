describe HttpStub::Models::StubResponse::Text do
  ...
  let(:response_text) { HttpStub::Models::StubResponse::Text.new(args) }

  it "is a base response" do
    expect(response_text).to be_a(HttpStub::Models::StubResponse::Base)
  end
